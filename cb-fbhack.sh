...
echo $i" |"$cy"     BLACK HUNTER TEAM"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" ALEX CB  [TEAM BHT CEO]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Alex CB"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [Itz Cb] [Itz Cbx] [CB]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [Alex CB]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 01945971168"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" chitronarts@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy" HACK FB PHP        "$i"|"$i"    |"$cy" B"$i" |"
echo $i"|"$me" 2"$i" |"$cy" HACK FB BR1G4D3    "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me" 3"$i" |"$cy" HACK FB iqbalz     "$i"|"$i"    |"$cy" N"$i" |"
echo $i"|"$me" 4"$i" |"$cy" HACK FB MBF        "$i"|"$i"    |"$cy" G"$i" |"
echo $i"|"$me" 5"$i" |"$cy" FACEHACK N1ght420       "$i"|"$i"    |"$cy" K"$i" |"
echo $i"|"$me" 6"$i" |"$cy" HACK FB ( root )   "$i"|"$i"    |"$cy" E"$i" |"
echo $i"────────────────────────────────"$i"    |"$cy" L"$i" |"
...
echo $i"|"$me"19"$i" |"$cy" EXIT PROGRAM      "$i"|"$i"    |"$cy" N"$i" |"
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"ALEX CB"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 1
git clone https://github.com/bht-ceo/cb-fbhack
cd cb-fbhack
php fb.php
fi
...
sleep 2
echo $ku"WhatsApp :"$i" 01945971168"
echo $ku"Facebook :"$i" Alex CB"
sleep 2
echo $pur">> Thanks for using my tool <<"
exit
fi